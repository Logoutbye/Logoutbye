...
INFO = [
    ("__header__", "muhammad bilal", ""),
    ("__rule__", "", ""),

    ("Role", "Full Stack Software Engineer", "val"),
    ("Exp", "3.5+ Years", "val"),
    ("Location", "Abbottabad, Pakistan", "val"),
    ("Focus", "Flutter · Node.js · System Design", "accent"),
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Flutter / Backend SDE roles</tspan>'
